...
STUDENT_IDENTIFIER="${SMOKE_STUDENT_IDENTIFIER:-S1001}"
STUDENT_PASSWORD="${SMOKE_STUDENT_PASSWORD:-Student123!}"
ADMIN_IDENTIFIER="${SMOKE_ADMIN_IDENTIFIER:-admin@university.edu}"
