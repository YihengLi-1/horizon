...
STUDENT_IDENTIFIER="${SMOKE_STUDENT_IDENTIFIER:-student1@sis.edu}"
STUDENT_PASSWORD="${SMOKE_STUDENT_PASSWORD:-Student@2026!}"
ADMIN_IDENTIFIER="${SMOKE_ADMIN_IDENTIFIER:-admin@sis.edu}"
ADMIN_PASSWORD="${SMOKE_ADMIN_PASSWORD:-Admin@2026!}"
