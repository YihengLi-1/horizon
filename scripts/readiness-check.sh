...
check_contains "apps/web/app/student/quick-add/page.tsx" "toast\\.success|toast\\.error" "Quick-add uses central toast"
...
check_exists "apps/web/app/student/saved-courses/page.tsx" "Student saved courses page"
check_contains "apps/web/app/student/catalog/page.tsx" "saved_courses|toggleSavedCourse|收藏" "Catalog saved courses toggle"
check_contains "apps/web/components/app-shell.tsx" "/student/saved-courses" "Saved courses nav link"
