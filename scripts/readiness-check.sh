...
check_contains "apps/web/app/(auth)/login/page.tsx" "教师与顾问工作台正在建设中" "Faculty/advisor portal deferred message on login"
check_not_exists "apps/web/app/faculty/dashboard/page.tsx" "Faculty portal removed (not yet built)"
check_not_exists "apps/web/app/advisor/dashboard/page.tsx" "Advisor portal removed (not yet built)"
...
check_contains "apps/web/app/admin/dashboard/page.tsx" "system-health|dbOk|totalStudents" "Dashboard system health data"
...
check_not_exists "apps/web/app/advisor/requests/page.tsx" "Advisor portal removed"
...
check_exists "apps/web/app/student/waitlist/page.tsx" "Student waitlist page exists"
check_contains "apps/web/app/student/waitlist/page.tsx" "registration/my-waitlist" "Student waitlist page uses real waitlist API"
...
check_not_exists "apps/web/app/student/what-if/page.tsx" "What-if page removed"
check_not_exists "apps/web/app/student/grade-estimator/page.tsx" "Grade estimator standalone page removed"
...
check_contains "apps/web/app/student/appeals/page.tsx" "appeals/new" "Student appeals page links to new appeal submission"
