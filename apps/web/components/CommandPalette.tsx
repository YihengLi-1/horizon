...
const COMMANDS = [
  ...
  { id: "student-receipt", label: "Enrollment Receipt", path: "/student/receipt", group: "Student", role: "student", icon: "🧾" },
  ...
  { id: "admin-faculty-schedule", label: "Faculty Schedule", path: "/admin/faculty-schedule", group: "Admin", role: "admin", icon: "🗓️" },
  ...
  { id: "admin-capacity-plan", label: "Capacity Plan", path: "/admin/capacity-plan", group: "Admin", role: "admin", icon: "📊" },
