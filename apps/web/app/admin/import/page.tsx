      ...
      <section className="campus-hero">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-3xl space-y-2">
            ...
            <h1 className="font-heading text-4xl font-bold text-white md:text-5xl">CSV Import</h1>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <span className="campus-chip border-blue-200/30 bg-white/10 text-blue-50">Target: {meta.label}</span>
              <span className="campus-chip border-blue-200/30 bg-white/10 text-blue-50">{Math.max(rowCount, 0)} data row(s)</span>
            </div>
          </div>
        </div>
      </section>
