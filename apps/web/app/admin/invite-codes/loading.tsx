    ...
    <div className="campus-page animate-pulse">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              {[1, 2, 3, 4].map((i) => <div key={i} className="h-6 w-20 rounded-full bg-slate-200" />)}
            </div>
          </div>
          <div className="flex gap-2">
      ...
      <div className="campus-card p-5 space-y-3">
        ...
        <div className="grid gap-3 md:grid-cols-4">
          {[1, 2, 3, 4].map((i) => <div key={i} className="h-10 rounded-xl bg-slate-200" />)}
        </div>
      </div>
      ...
      <div className="campus-card overflow-hidden">
        ...
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="flex items-center gap-4 px-4 py-3 border-b border-slate-100">
            <div className="h-4 w-32 rounded-full bg-slate-200 font-mono" />
